...
export default [
  ...
  // ── KD v2 — Landing + Dashboard (dev-2) ─────────────────────────
  {
    path: "/kd",
    name: "kd-landing",
    component: () => import("../views/kd/KDLanding.vue"),
    meta: { title: "ZENZERO KD — Wastewater Treatment Monitor" },
  },
  {
    path: "/kd/app",
    component: () => import("../views/kd/KDLayout.vue"),
    meta: { title: "STA-KD Dashboard" },
    children: [
      { path: "", redirect: "/kd/app/overview" },
      {
        path: "overview",
        name: "kd-overview",
        component: () => import("../views/kd/overview/index.vue"),
        meta: { title: "Overview" },
      },
      {
        path: "executive",
        name: "kd-executive",
        component: () => import("../views/kd/executive/index.vue"),
        meta: { title: "Executive Summary" },
      },
      {
        path: "daily-report",
        name: "kd-daily-report",
        component: () => import("../views/kd/daily-report/index.vue"),
        meta: { title: "Daily Report" },
      },
      {
        path: "remote-control",
        name: "kd-remote-control",
  ...
  // ── STA-KD Process Dashboard (dev) ───────────────────────────────
  {
    path: "/sta-kd",
    component: () => import("../views/sta-kd/STAKDLayout.vue"),
    meta: { title: "STA-KD Dashboard" },
    children: [
      { path: "", redirect: "/sta-kd/home" },
      {
        path: "home",
        name: "sta-kd-home",
        component: () => import("../views/sta-kd/home/index.vue"),
        meta: { title: "STA-KD Home" },
      },
      {
        path: "pump",
        name: "sta-kd-pump",
        component: () => import("../views/sta-kd/pump/index.vue"),
        meta: { title: "STA-KD Pump" },
      },
      {
        path: "blower",
        name: "sta-kd-blower",
        component: () => import("../views/sta-kd/blower/index.vue"),
        meta: { title: "STA-KD Blower" },
      },
      {
        path: "sensor",
        name: "sta-kd-sensor",
        component: () => import("../views/sta-kd/sensor/index.vue"),
        meta: { title: "STA-KD Sensor" },
      },
      {
        path: "control",
        name: "sta-kd-control",
        component: () => import("../views/sta-kd/control/index.vue"),
        meta: { title: "STA-KD Control" },
      },
      {
        path: "energy",
        name: "sta-kd-energy",
        component: () => import("../views/sta-kd/energy/index.vue"),
        meta: { title: "STA-KD Energy" },
      },
      {
        path: "report",
        name: "sta-kd-report",
        component: () => import("../views/sta-kd/report/index.vue"),
        meta: { title: "STA-KD Report" },
      },
      {
        path: "devices",
        name: "sta-kd-devices",
        component: () => import("../views/sta-kd/devices/index.vue"),
        meta: { title: "STA-KD Devices" },
      },
    ],
  },
  // ─────────────────────────────────────────────────────────────────
