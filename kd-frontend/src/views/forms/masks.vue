                ...
                <BRow>
                  <BCol xl="6">
                    <div>
                      ...
                      <BFormInput type="text" v-maska data-maska="['# cm', '#.# cm', '#.## cm']" class="form-control" id="regexp-mask"/>
                      <div class="text-muted">["# cm", "#.# cm", "#.## cm"]</div>
                    </div>

                    <div class="mt-4">
                      <label for="phone-mask" class="form-label">Phone with code</label>
                      <BFormInput type="text" v-maska data-maska="['+1 (###) ##-##-##', '+1 (###) ###-##-##']" class="form-control"
                        id="phone-mask"/>
                  ...
                  <BCol xl="6">
                    ...
                    <div class="mt-4">
                      ...
                      <BFormInput type="text"
                        v-maska 
                        data-maska="['!#HHHHHH', '!#HHHHHH-HH']"
                        data-maska-tokens="H:[0-9a-fA-F]uppercase"
